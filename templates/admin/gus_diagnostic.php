<h1><?= $lang('gus_diagnostics') ?></h1>

<div class="section">
    <div class="form-card" style="padding:16px;">
        <form method="get" action="/admin/gus-diagnostic" style="display:flex; gap:12px; align-items:end; flex-wrap:wrap; margin-bottom:20px;">
            <div>
...
<div class="section">
    <h2>Log GUS API</h2>
    <p style="color:#888; font-size:0.9em;">Pełny log zapytań i odpowiedzi SOAP. Skopiuj i przekaż do analizy.</p>
    <div style="position:relative;">
        ...
        <textarea id="gus-log" readonly style="width:100%; height:500px; font-family:monospace; font-size:0.8em; background:#1a1a2e; color:#e0e0e0; border:1px solid #333; border-radius:8px; padding:12px; white-space:pre; overflow:auto; resize:vertical;"><?= htmlspecialchars($logContent) ?></textarea>
    </div>
</div>

<script>
function copyLog() {
    var ta = document.getElementById('gus-log');
    ta.select();
