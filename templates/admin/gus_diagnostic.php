...
<div class="section">
    ...
    <div style="position:relative;">
        ...
        <textarea id="gus-log" class="diagnostic-log" readonly style="width:100%; height:500px; font-family:monospace; font-size:0.8em; border-radius:8px; padding:12px; white-space:pre; overflow:auto; resize:vertical;"><?= htmlspecialchars($logContent) ?></textarea>
    </div>
</div>
