...
<div class="form-card" style="padding:20px; margin-bottom:20px;">
    <div style="display:flex; justify-content:space-between; align-items:center; flex-wrap:wrap; gap:12px;">
        <form method="GET" action="/office/duplicates" style="display:flex; gap:12px; align-items:flex-end; flex-wrap:wrap;">
        ...
        <form method="POST" action="/office/duplicates/scan" style="display:inline;">
                    ...
                    <tr style="<?= $dc['status'] !== 'pending' ? 'opacity:0.6;' : '' ?>">
                        ...
                        <td style="white-space:nowrap;">
                            <?php if ($dc['status'] === 'pending'): ?>
                                <form method="POST" action="/office/duplicates/<?= $dc['id'] ?>/review" style="display:inline;">
                                    <input type="hidden" name="csrf_token" value="<?= $csrf ?>">
