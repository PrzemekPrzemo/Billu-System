...
class DemoSeederService
{
    ...
    public static function seedAll(): array
    {
        ...
        $officeId = Office::create([
            ...
            'email'               => 'demo-biuro@faktupilot.pl',
        ...
        $credentials[] = [
            'type' => 'Biuro księgowe',
            'name' => 'Demo Biuro Księgowe Sp. z o.o.',
            'login' => 'demo-biuro@faktupilot.pl',
        ...
        $clientDefs = [
            [
                ...
                'email'        => 'demo-techsoft@faktupilot.pl',
            ...
            [
                ...
                'rep'          => 'Maria Zielińska',
                'email'        => 'demo-handel@faktupilot.pl',
            ...
            [
                ...
                'rep'          => 'Tomasz Kamiński',
                'email'        => 'demo-budexpert@faktupilot.pl',
