...
CREATE TABLE IF NOT EXISTS client_employees (
    ...
    nfz_branch VARCHAR(4) DEFAULT NULL,
    is_active TINYINT(1) NOT NULL DEFAULT 1,
...
CREATE TABLE IF NOT EXISTS employee_contracts (
    ...
    work_time_fraction DECIMAL(3,2) DEFAULT 1.00,
    position VARCHAR(255) DEFAULT NULL,
    ...
    zus_chorobowa TINYINT(1) NOT NULL DEFAULT 0,
    ...
    tax_deductible_costs ENUM('basic', 'elevated') DEFAULT 'basic',
    pit_exempt TINYINT(1) NOT NULL DEFAULT 0,
    uses_kwota_wolna TINYINT(1) NOT NULL DEFAULT 1,
    ppk_employee_rate DECIMAL(4,2) DEFAULT 2.00,
    ppk_employer_rate DECIMAL(4,2) DEFAULT 1.50,
    ppk_active TINYINT(1) NOT NULL DEFAULT 0,
    dzielo_kup_rate DECIMAL(4,2) DEFAULT 20.00,
...
CREATE TABLE IF NOT EXISTS payroll_entries (
    ...
    health_insurance_full DECIMAL(10,2) NOT NULL DEFAULT 0,
    health_insurance_deductible DECIMAL(10,2) NOT NULL DEFAULT 0,
    ...
    calculation_json TEXT DEFAULT NULL,
    created_at DATETIME DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS employee_leave_balances (
    ...
    on_demand_used INT NOT NULL DEFAULT 0,
...
-- Update HR module and add payroll sub-modules
UPDATE modules SET name = 'Kadry i Płace', description = 'Zarządzanie kadrami i płacami pracowników klienta' WHERE slug = 'hr';
...
-- Seed commercial bundles (base per office + per client, netto PLN)
...
('Starter', 'starter', 'Weryfikacja faktur zakupowych, kontrahenci, komunikacja z klientem. Idealny na start.', '["invoices","security","contractors","company-profile","messages","files"]', 0.00, 9.00, 0, 1),
('Professional', 'professional', 'Fakturowanie sprzedażowe, integracja KSeF, wykrywanie duplikatów, kalendarz podatkowy.', '["invoices","security","contractors","company-profile","messages","files","sales","ksef","duplicates","tax-calendar"]', 0.00, 14.00, 0, 2),
('Tax & Finance', 'tax-finance', 'Pełna obsługa podatkowa: kalkulatory, płatności, raporty JPK/VAT, analityka, eksport ERP.', '["invoices","security","contractors","company-profile","messages","files","sales","ksef","duplicates","tax-calendar","tax-calculator","tax-payments","reports","analytics","erp-export"]', 49.00, 16.00, 0, 3),
('HR & Payroll', 'hr-payroll', 'Dodatek Kadry i Płace: pracownicy, umowy, listy płac, urlopy, deklaracje PIT/ZUS.', '["hr","payroll-calc","payroll-lists","payroll-contracts","payroll-leave","payroll-pit","payroll-zus"]', 29.00, 4.00, 1, 4),
('Enterprise', 'enterprise', 'Pełny dostęp do wszystkich modułów BiLLU z HR i zadaniami.', '["invoices","security","contractors","company-profile","messages","files","tasks","sales","ksef","duplicates","tax-calendar","tax-calculator","tax-payments","reports","analytics","erp-export","hr","payroll-calc","payroll-lists","payroll-contracts","payroll-leave","payroll-pit","payroll-zus"]', 49.00, 19.00, 0, 5);
